...
public class ContactBuilder {
	...
	public ContactBuilder setAadhar(Aadhar aadhar) {
		this.aadhar = aadhar;
		return this;
	}
	...
	public Contact build() {
		return new Contact(this.firstName, this.lastName, this.email, this.mobile, this.home, this.work, this.landline, this.gender, this.address, this.website, this.aadhar);
	}
